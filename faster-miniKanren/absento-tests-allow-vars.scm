; Tests commented out are for general absento; this implementation
; only supports absento where the first argument is a ground atom, or
; a variable that represents a ground atom (the first argument to
; absento cannot be a tree term).
